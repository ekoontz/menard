...
#?(:clj
   (defn load-lexicon [lexical-rules]
     (merge-with concat
                 ...
                 (compile-lexicon-source (model/use-path "menard/nederlands/lexicon/exclamations.edn")
                                         lexical-rules {:cat :exclamation})
                 (compile-lexicon-source (model/use-path "menard/nederlands/lexicon/intensifiers.edn")
                                         lexical-rules {:cat :intensifier})
