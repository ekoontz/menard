...
;; generation:
;; expected: this spec should fail to generate an expression
;; actual:   spec generates: "u probeert je te zien"
;; parsing:
;; expected: "u probeert je te zien" should fail to parse
;; actual: fails to parse (so works as expected).
(def the-bad-spec
  {:cat :verb,
   :subcat [],
   :reflexive false
   ...
   {:rule "vp-modal-np",
    ...
    :head {:exception false 
           :phrasal false, 
           :modal :te}
    :comp {:comp {:phrasal false :canonical "je"}}}
   :sem {:subj {:pred :you :person :2nd}
         :pred :try, :obj {:pred :see}}
   :comp {:phrasal false
          :canonical "u"
  ...
  {:cat :verb,
   ...
   {:rule "vp-modal-np",
    ...
    :head {:exception false 
           :phrasal false, 
           :modal :te}
    :comp {:comp {:phrasal false :canonical "u"}}}
   :sem {:subj {:pred :you :person :2nd}
         :pred :try, :obj {:pred :see}}
   :comp {:phrasal false
          :canonical "u"
...
(def the-good-spec-2
  {:rule "s"
   ...
   {:rule "vp-modal-np",
    ...
    :comp {:rule "vp-np"
           :head {:rule "vp-te"
                  :head {:phrasal false :canonical "te"}
                  :comp {:phrasal false :canonical "zien"}}}}
   :sem {:subj {:pred :you :person :2nd}
         :pred :try, 
         :obj {:pred :see
               :obj {:top :top}}}
